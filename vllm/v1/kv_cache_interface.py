...
class DFlashSWASpec(SlidingWindowSpec):
    ...
    # True only when the GLM grouping lane has reserved private worker-owned
    # ring pages. The scheduler manager, allocator, and worker all consume
    # this stamped invariant so pool ownership cannot diverge.
...
class KVCacheTensor:
    ...
    """Physical blocks in this placement; None uses KVCacheConfig.num_blocks."""
